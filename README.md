...
```kotlin
// commonMain
implementation("dev.avinya.ads:admob-cmp:2.5.0")
```
...
> ```kotlin
> plugins {
>     id("dev.avinya.ads.admob-cmp") version "2.5.0"
> }
> ```
...
Underlying Google SDKs bound by 2.5.0:
